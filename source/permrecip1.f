...
c
         ...
         gradfield_recip(2,1,i) = gradfield_recip(2,1,i) + cphi(8,i)
         gradfield_recip(3,1,i) = gradfield_recip(3,1,i) + cphi(9,i)
         gradfield_recip(3,2,i) = gradfield_recip(3,2,i) + cphi(10,i)
c
         ...
         hessfield_recip(2,1,1,i) = hessfield_recip(2,1,1,i) +cphi(14,i)
         hessfield_recip(3,1,1,i) = hessfield_recip(3,1,1,i) +cphi(15,i)
         hessfield_recip(2,2,1,i) = hessfield_recip(2,2,1,i) +cphi(16,i)
         hessfield_recip(3,2,2,i) = hessfield_recip(3,2,2,i) +cphi(17,i)
         hessfield_recip(3,3,1,i) = hessfield_recip(3,3,1,i) +cphi(18,i)
         hessfield_recip(3,3,2,i) = hessfield_recip(3,3,2,i) +cphi(19,i)
         hessfield_recip(3,2,1,i) = hessfield_recip(3,2,1,i) +cphi(20,i)
      end do
c
